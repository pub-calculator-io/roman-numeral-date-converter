...
Version: 1.0.0
Author: Roman Numeral Date Converter / www.calculator.io
...
function display_calcio_ci_roman_numeral_date_converter(){
    $page = 'index.html';
...
add_shortcode( 'ci_roman_numeral_date_converter', 'display_calcio_ci_roman_numeral_date_converter' );